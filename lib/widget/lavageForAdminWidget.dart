...
import 'package:polylavery/screen/detailCommandeAdmin.dart';
...
class LavageForAdminWidget extends StatelessWidget {
  Commande commande;

  LavageForAdminWidget(this.commande, {super.key});
    ...
    return GestureDetector(
        onTap: () {
          Navigator.push(
              ...
              MaterialPageRoute(
                  builder: (context) =>
                      DetailCommandeAdmin(commande.idCommande)));
          // showDialog(
          //     context: context,
          ...
          //         return DetailCommandeAdmin(detailCommande);
          //       }
          //     })));
        },
        child: Container(
            ...
            child: Column(
              ...
              children: [
                Center(
                  child: Text(
                    "${commande.prenom} ${commande.nom.toUpperCase()} ${commande.promo} ème",
                    textAlign: TextAlign.center,
                    style: TextStyle(
